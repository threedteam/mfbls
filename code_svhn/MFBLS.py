'''
@to do:using hsv+hog+kmeans+conv features to classify the SVHN datasets
@link:train.mat,extra.mat,and test.mat are downloaded from http://ufldl.stanford.edu/housenumbers/
'''

from __future__ import print_function, division
from keras.utils.np_utils import to_categorical
from ImFea_SVHN import saveHsvFea,saveHogFea,saveKmeansFea,saveConvFea
...
def MFBLS(x_train, train_y, x_val, val_y, x_test, test_y):
    ...
    # feat
    # conv
    x_train_conv = np.load("../result_svhn/x_train_conv.npy")  # -train
    x_val_conv = np.load("../result_svhn/x_val_conv.npy")  # -val
    x_test_conv = np.load("../result_svhn/x_test_conv.npy")  # -test

    # k_means
    x_train_kmeans = np.load("../result_svhn/x_train_kmeans.npy")
    x_val_kmeans = np.load("../result_svhn/x_val_kmeans.npy")
    x_test_kmeans = np.load("../result_svhn/x_test_kmeans.npy")

    # # hog
    x_train_hog = np.load("../result_svhn/x_train_hog.npy")
    x_val_hog = np.load("../result_svhn/x_val_hog.npy")
    x_test_hog = np.load("../result_svhn/x_test_hog.npy")

    #hsvs
    x_train_hsvs = np.load("../result_svhn/x_train_hsvs.npy")
    x_val_hsvs = np.load("../result_svhn/x_val_hsvs.npy")
    x_test_hsvs = np.load("../result_svhn/x_test_hsvs.npy")
