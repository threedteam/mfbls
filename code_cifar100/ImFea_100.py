'''
@to do:save hog,hsv,kmeans,conv feature on cifar100
@link:
'''
...
def saveHsvFea(x_train,x_val,x_test):
    ...
    '''保存所有特征'''
    np.save("../result_cifar100/x_train_hsvs.npy", x_train_hsv)
    np.save("../result_cifar100/x_val_hsvs.npy", x_val_hsv)
    np.save("../result_cifar100/x_test_hsvs.npy", x_test_hsv)
...
def saveHogFea(x_train,x_val,x_test):
    ...
    '''保存所有特征'''
    np.save("../result_cifar100/x_train_hog.npy", x_train_hog)
    np.save("../result_cifar100/x_val_hog.npy", x_val_hog)
    np.save("../result_cifar100/x_test_hog.npy", x_test_hog)
...
def saveKmeansFea(x_train,x_val,x_test):
    ...
    '''保存所有特征'''
    np.save("../result_cifar100/x_train_kmeans.npy", x_train_kmeans)
    np.save("../result_cifar100/x_val_kmeans.npy", x_val_kmeans)
    np.save("../result_cifar100/x_test_kmeans.npy", x_test_kmeans)
...
def saveConvFea(x_train, x_val, x_test, kernel_number_para,pca_para):
    ...
    '''保存所有特征'''
    np.save("../result_cifar100/x_train_conv.npy", x_train_conv)
    np.save("../result_cifar100/x_val_conv.npy", x_val_conv)
    np.save("../result_cifar100/x_test_conv.npy", x_test_conv)
